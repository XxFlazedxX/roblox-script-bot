...
async def add_player(ctx, roblox_username: str, roblox_id: int = None):
...
async def remove_player(ctx, roblox_username: str):
    guild_id = str(ctx.guild.id)
...
@bot.command(name='statusplayers')
async def status_players(ctx):
    guild_id = str(ctx.guild.id)
    ...
    embed.set_footer(text=f"Last updated | Requested by {ctx.author}")
    await ctx.send(embed=embed)

@bot.command(name='playerinfo')
async def player_info(ctx, roblox_username: str):
    guild_id = str(ctx.guild.id)
...
@bot.command(name='scriptban')
async def script_ban(ctx, roblox_username: str, *, reason: str = "No reason provided"):
    guild_id = str(ctx.guild.id)
...
@bot.command(name='scriptunban')
async def script_unban(ctx, roblox_username: str):
    guild_id = str(ctx.guild.id)
...
@bot.command(name='scriptbanlist')
async def script_banlist(ctx):
    guild_id = str(ctx.guild.id)
...
@bot.command(name='scriptkick')
async def script_kick(ctx, roblox_username: str, *, reason: str = "No reason provided"):
    guild_id = str(ctx.guild.id)
